...
export class Game{
    ...
    update(){
        ...
        if(deltaTime2 >= 50){
            this.boardTetris.dibujar();
            this.drawTetrominoGhost();
            this.currentTetromino.dibujar(this.boardTetris);
    ...
    placeTetromino(){
        ...
        this.score += this.boardTetris.cleanFullRows()*10;
    ...
    drawTetrominoGhost(){
        ...
        const tetrominoPositions = this.currentTetromino.currentPositions();
        for(let i = 0; i < tetrominoPositions.length; i++){
            let position = this.boardTetris.getCoords(
                tetrominoPositions[i].column,
